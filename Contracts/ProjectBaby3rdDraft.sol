...
contract MkopoFactory {
    Mkopo[] public deployedMikopo;   // Hii coz ina-hold objects of deployed Instances of Mkopo you should use Mkopo here instead of Address, hii ni 
    // syntax mpya in solidity 0.8.0 na zingnezo kumbuka kwenye course mara nyingi tulikua tunatumia Address see your Course materials
...
contract Mkopo {
    ...
    */
    function namkopesha(DeniDetails memory deni) public payable{
        ...
        // Kuna logics hapo chini za kuendelea nazo... Ila kwenye Remix zimework vizuri hizi code so usiwaze...
    }
